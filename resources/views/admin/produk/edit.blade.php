    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($data, ['route' => ['produks.update', $data],'method' =>'patch', 'class'=>'form-horizontal margin-bottom-40', 'role'=>'form','files' => true])!!}
                        @include('admin.produk._form',['model' => $data])
                        <br>
                        <div class="row">
